...
/** Pi package entry point. Parent orchestration remains inert for this slice. */
export default function registerWorkerGraph(pi: ExtensionAPI): void {
  if (process.env[WORKER_ROLE_VARIABLE] !== WORKER_ROLE) return;
